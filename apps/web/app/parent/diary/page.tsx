...
export default function ParentDiaryPage() {
  ...
  return (
    <section className="flex flex-col gap-4">
      <div>
        <h2 className="text-2xl font-semibold tracking-tight">Child diary</h2>
        <p className="text-sm text-muted-foreground">
          Grades, homework, schedule, and attendance for the selected child.
        </p>
      </div>

      {!childrenQuery.isLoading && !selectedChild ? (
        <Card>
      ...
      <Card>
        ...
        <CardContent className="grid gap-3 sm:grid-cols-[minmax(0,1fr)_minmax(10rem,12rem)_minmax(9rem,12rem)_minmax(9rem,12rem)_auto] sm:items-end">
          <div className="flex flex-col gap-2">
            <Label htmlFor="parent-diary-subject">Subject</Label>
            <Select value={subjectId} onValueChange={setSubjectId}>
              <SelectTrigger id="parent-diary-subject" className="w-full">
          ...
          <div className="flex flex-col gap-2">
            <Label htmlFor="parent-diary-type">Type</Label>
            <Select
              value={entryType}
              onValueChange={(value) => setEntryType(value as DiaryEntryType)}
            >
              <SelectTrigger id="parent-diary-type" className="w-full">
          ...
          <div className="flex flex-col gap-2">
            <Label htmlFor="parent-diary-from">From</Label>
            <Input
              id="parent-diary-from"
              type="date"
              value={dateFrom}
          ...
          <div className="flex flex-col gap-2">
            <Label htmlFor="parent-diary-to">To</Label>
            <Input
              id="parent-diary-to"
              type="date"
              value={dateTo}
      ...
      <div className="grid gap-4 lg:grid-cols-3">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Next lessons from the selected child schedule.
            </CardDescription>
          </CardHeader>
